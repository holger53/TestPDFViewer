...
using System.IO;
using System.Text.Json;  // GE�NDERT: Von Newtonsoft.Json zu System.Text.Json
...
namespace PdfiumOverlayTest
{
    public partial class CompanyDataDialog : Form, ILocalizable
    {
        ...
        private void AddLabelAndTextBox(string labelText, ref TextBox textBox, int y, int labelWidth, int textBoxLeft, int textBoxWidth)
        {
            ...
            // Panel als Container f�r TextBox (erm�glicht Padding)
            var panel = new Panel
            {
        ...
        private void CompanyDataDialog_Load(object? sender, EventArgs e)
        {
            ...
            try
            {
                if (File.Exists(filePath))
                {
                    ...
                    // GE�NDERT: Verwende System.Text.Json statt Newtonsoft
        ...
        public void UpdateUI()
        {
            ...
            // Daher keine Runtime-Aktualisierung nötig
        }
    }
}
